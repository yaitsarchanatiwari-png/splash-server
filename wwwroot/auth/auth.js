...
document.addEventListener('DOMContentLoaded', () => {
  ...
  signinForm.addEventListener('submit', async (e) => {
    ...
    try {
      // First try /api/admin/login if it's admin or AzPlayzZ
      const isAdminCandidate = username.toLowerCase() === 'admin' || username.toLowerCase() === 'azplayzz';
      const endpoint = isAdminCandidate ? '/api/admin/login' : '/api/auth/login';
